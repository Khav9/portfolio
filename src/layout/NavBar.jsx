      ...
      <div className="bg-black sticky top-0 z-50 p-4 flex items-center justify-between sm:hidden">
        ...
        <div className="flex items-center space-x-6">
          ...
          <button
            ...
            type="button"
            className="inline-flex items-center text-sm text-gray-500 rounded-lg sm:hidden hover:text-gray-100 focus:outline-none focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
          >
